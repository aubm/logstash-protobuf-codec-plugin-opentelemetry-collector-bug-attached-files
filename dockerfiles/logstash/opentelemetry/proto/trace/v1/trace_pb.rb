...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("opentelemetry/proto/trace/v1/trace.proto", :syntax => :proto3) do
    ...
    add_enum "opentelemetry.proto.trace.v1.SpanFlags" do
      value :SPAN_FLAGS_DO_NOT_USE, 0
      value :SPAN_FLAGS_TRACE_FLAGS_MASK, 255
    end
  end
end
